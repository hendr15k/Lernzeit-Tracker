...
- Drücke den Play-Button in der Kopfzeile oder den Floating Action Button (FAB) unten rechts
- Wähle ein Fach aus dem Dropdown-Menü
- Optional: Gib ein Thema ein (Autocomplete basierend auf früheren Eingaben)
